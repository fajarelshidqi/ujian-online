...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-edit"></i> Ruang Ujian</a></li>
    </ol>
</section>
    ...
    <div class="col-md-9">
        <div class="box box-success box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Bacalah Soal dengan teliti</h3>
            </div><!-- /.box-header -->
            <div class="box-body" style="overflow-y: scroll;height: 525px;">
                <form id="formSoal" role="formSoal" action="<?php echo base_url(); ?>ruang_ujian/jawab_essay" method="post" onsubmit="return confirm('Anda Yakin ?')">

                    <input type="hidden" name="id_peserta" value="<?php echo $id['id_peserta']; ?>">
                    <input type="hidden" name="id_mk" value="<?php echo $id_matakuliah; ?>">
                            ...
                            <table class="table table-bordered table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo $s->soal_essay; ?>
                                            <input type='hidden' name='soal[]' value='<?php echo $s->id_soal_essay; ?>' />
                                            <textarea name="jawaban[<?php echo $s->id_soal_essay; ?>]" rows="5" cols="100" placeholder="Tuliskan Jawaban Anda disini."></textarea>
                                        </td>
                                    </tr>
