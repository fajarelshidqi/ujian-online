    ...
    <div class="col-md-12">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          ...
          <?php echo '<button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal-data" onclick="$(\'#modal-data-body\').load(\'' . base_url('jenis_ujian/create') . '\')"><span class="fa fa-plus"></span> Data Jenis Ujian</button>' ?>
        </div>
        <!-- /.box-header -->
...
<div class="modal fade" id="modal-import">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- /.form dengan modal -->
      <form action="<?= base_url('mahasiswa/import'); ?>" method="post" class="form-horizontal">
        <div class="box-body">
