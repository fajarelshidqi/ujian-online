...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#"></a> Update Soal Ujian</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <form action="<?=base_url('daftar_soal/update');?>" method="post">
                            ...
                            <div class="col-sm-10">
                                <select class="select2 form-control" name="nama_matakuliah" required="">
                                    ...
                                    <?php foreach($kelas as $a) { ?>
                                      <option value="<?=$a->id_matakuliah?>" <?php if($s->nama_matakuliah==$a->nama_matakuliah){echo "selected='selected'";} ?>><?= $a->kode_matakuliah;?> | <?= $a->nama_matakuliah;?></option>
                                  <?php } ?>
                                </select>
