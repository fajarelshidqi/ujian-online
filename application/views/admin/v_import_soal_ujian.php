...
<section class="content-header">
    <h1>
        Import Data Soal Ujian
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#"> Import Data</a></li>
        <li><a href="#"> Import Data Soal Ujian</a></li>
    </ol>
</section>
            ...
            <form action="<?=base_url('admin/import_mhs_aksi')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <div class="col-sm-12">
                    <a href="<?=base_url('format/format-soal-ujian.xlsx')?>" class="pull-right" download><i class="fa fa-download"></i> Download Format Import Soal PG</a>                      
                  </div>
                </div>
