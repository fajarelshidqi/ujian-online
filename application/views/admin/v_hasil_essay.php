                ...
                <form action="" method="get" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <a href="<?= base_url('hasil_essay'); ?>" class="btn btn-default btn-flat"><span class="fa fa-refresh"></span> Refresh</a>
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <div class="box box-header" >
                    <?php if (isset($_GET['id'])) {
                        $id = $_GET['id']; 
                    ?>
                    <a href="<?=base_url().'hasil_essay/print_all?id='.$id ?>" class="btn btn-danger btn-flat" target="_blank"><i class="fa fa-file-pdf-o"></i> Cetak Sesuai Filter</a>
                    <?php } ?>

                    <a href="<?=base_url('hasil_essay/print_all')?>" class="btn btn-primary btn-flat pull-right" target="_blank"><i class="fa fa-print"></i> Cetak Semua Hasil Ujian</a>
                </div>
              <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($d->bobot_essay == null){
                                        ...
                                        echo "<a href='".'hasil_essay/cetak/'."$d->id_peserta' class='btn btn-xs btn-primary' title='Cetak Hasil Ujian' target='_blank'><span class='fa fa-print'></span></a>";;
                                    }
                                    ?>
                                </td> 
                            </tr>
