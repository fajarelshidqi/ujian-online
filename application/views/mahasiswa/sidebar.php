  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Menu Home -->
        <li <?= $this->uri->segment(1) == 'ruang_mahasiswa' ? 'class="active"' : ''?>>
          <a href="<?php echo base_url('ruang_mahasiswa');?>"><i class="fa fa-home"></i> 
            <span>Home</span>
          </a>
        </li>
        <!-- Tutup Menu Home -->
        ...
        <li <?= $this->uri->segment(1) == 'jadwal' || $this->uri->segment(1) == '' ? 'class="active"' : ''?>>
          <a href="<?php echo base_url('jadwal');?>"><i class="fa fa-calendar-check-o"></i> 
