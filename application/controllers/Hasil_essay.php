...
class Hasil_essay extends CI_Controller
{
	...
	{	
		...
		$this->mypdf->generate('admin/v_cetak_essay', $data, 'Cetak Hasil Ujian PG', 'A4', 'landscape');
	}
	...
	public function cetak($id)
	{
		...
		$this->mypdf->generate('admin/v_cetak_essay', $data, 'Cetak Hasil Ujian Essay', 'A4', 'landscape');
	}
}
